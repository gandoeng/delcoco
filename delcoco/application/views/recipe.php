...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<section class="recipe1"><?php $this->load->view('menu');?><div class="container-fluid">
			<div class="row">
						...
						<div class="form-inline">
							<div class="col-xs-12 col-sm-7 nopad">
								<ul class="nav nav-pills text-center dishes">
									...
									<li class="dishes-btn <?php if ($category_id == $category->id_category): ?>active<?php endif; ?>">
										<a href="<?= base_url(); ?>recipe/all/<?= $category->id_category; ?>">
											<h4><?= $category->name; ?></h4>
										</a>
									</li>
									<?php endforeach; ?>
							...
							<div class="col-xs-12 col-sm-5 searching-wrapper">
								...
								<button id="btn-search" class="btn search" onclick="search(1);">
									<img src="<?= base_url(); ?>images/loop.png" />
								</button>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 tab-content nopad">
						<div id="dessert" class="col-xs-12 col-sm-12 nopad tab-pane fade in active dessert">
							<?php foreach ($arr_recipe as $key => $recipe): ?>
							<div class="col-xs-6 col-sm-4 recipe-list">
								<div class="col-xs-12 col-sm-12 recipe-image-wrap">
									<a href="<?= base_url(); ?>recipe/detail/<?= $recipe->id; ?>/">
										<div class="col-xs-12 col-sm-12 recipe-image" style="background-image:url(<?= base_url(); ?>images/website/<?= $recipe->image_name ?>);"></div>
									</a>
								</div>
								<div class="col-xs-12 col-sm-12 recipe-content-wrap">
									...
									<div class="col-xs-12 col-sm-12 socmed-wrap">
										...
										<div class="col-xs-12 col-sm-7 nopad v-center notif">
											<div class="love-wrap">
												<a href="#">
													<img class="love" src="<?= base_url(); ?>images/love.png" />
												</a>
								...
								<ul class="pagination pagination-lg recipe-pagination">
									<li>
										<a onclick="prev();" style="cursor: pointer;">
											<i class="fa fa-angle-left fa-lg prev-page"></i>
										</a>
									</li>
									<?php for ($i = 1; $i <= $count_recipe; $i++): ?>
									<li>
										<a onclick="changePage('<?= $i; ?>');" style="cursor: pointer;" class="<?php if ($i == $page): ?>page-active<?php endif; ?>"><?= $i; ?></a>
									</li>
									<?php endfor; ?>
									<li>
										<a onclick="next();" style="cursor: pointer;">
											<i class="fa fa-angle-right fa-lg next-page"></i>
										</a>
									</li>
								</ul>
							</div>
