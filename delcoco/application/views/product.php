	...
	<body>
		<section class="product1">
            ...
            <div class="container-fluid product-section-1">
                <div class="row"><div class="col-xs-12 col-sm-12">
                    ...
                    </div><!----><div class="col-xs-12 col-sm-4 v-center">
                    ...
                    </div><!----><?php foreach ($arr_benefit as $key => $benefit): ?> <div id="product-benefit-<?= $benefit->id; ?>" class="col-xs-12 col-sm-4 v-center product1-content" <?php if ($key != 1): ?>style="display: none;"<?php endif; ?>>
                    ...
                    <div class="col-xs-12 col-sm-4 col-sm-offset-4">
                        <div class="owl-carousel owl-theme product-slider-1">
                            <?php foreach ($arr_benefit as $key => $benefit): ?>
                                <div class="item item-benefit"><div class="green-circle <?php if ($key == 1): ?>benefit-opacity-on<?php else: ?>benefit-opacity-off<?php endif; ?>">
                                    <div class="white-circle-border">
                                        <div class="circle-padding"></div>
                                    </div>
                                </div>
                                <div class="item-pict text-center" data-id-benefit="<?= $benefit->id; ?>">
                                    <img src="<?= base_url(); ?>images/website/<?= $arr_benefit_image_lookup[$benefit->id_benefit]['Thumbnail'] ?>" data-src="<?= base_url(); ?>images/website/<?= $arr_benefit_image_lookup[$benefit->id_benefit][''] ?>" />
                                </div>
                            </div>
                        <?php endforeach; ?>
                        </div>
		...
		<section class="product3">
    		<div class="container-fluid product-section-3">
        		<div class="row">
            		<div class="col-xs-12 col-sm-12">
                		...
                		<div class="col-xs-12 col-sm-12" style="padding: 0 5%;">
                    		<div class="owl-carousel owl-theme coconut-slider">
                        		<?php foreach ($arr_product_main as $key => $product_main): ?><?php if (count($arr_product_image_lookup[$product_main->id_product]) <= 0): ?><?php continue; ?><?php endif; ?>
                        		<div class="item coconut-item" data-product-id="<?= $product_main->id_product; ?>">
                    	...
                    	<?php foreach ($arr_product as $key => $product): ?>
                    		<div id="product-detail-<?= $product->id_product; ?>" class="content-product <?php if ($key > 0): ?>display-none<?php endif; ?>">
                        		<div class="col-xs-12 col-sm-5">
                            		<div class="col-xs-12 col-sm-12 nopadleft product-big-zoom-wrap">
                                		<div class="col-xs-12 col-sm-12 nopad product-big-zoom" style="background-image: url(<?=base_url();?>images/website/<?=$arr_product_image_lookup[$product->id_product][0];?>);"></div>
                            		</div>
                            		<div class="col-xs-12 col-sm-12 nopad product-small-zoom-wrap">
                                		<?php foreach ($arr_product_image_lookup[$product->id_product] as $product_image): ?>
                                		<div class="col-xs-4 col-sm-4 nopadleft product-small-zoom">
                                    		<div class="col-xs-12 col-sm-12 product-small-border" style="background-image: url(<?=base_url();?>images/website/<?=$product_image;?>);" data-src="<?= base_url(); ?>images/website/<?= $product_image; ?>"></div>
                                		</div>
                                		<?php endforeach; ?>
                            		</div>
                        		</div>
                        		<div class="col-xs-12 col-sm-7 product-detail-tab-wrapper">
                           			<ul class="nav nav-pills product-detail-tab">
                                		<li class="active"><a data-toggle="pill" href="#type-<?= $product->id_product; ?>-1"><?php echo $this->lang->line('product_type') ?></a></li>
                                		<li><a data-toggle="pill" href="#packaging-<?= $product->id_product; ?>-1"><?php echo $this->lang->line('product_packaging') ?></a></li>
                            		</ul>
                            	<div class="tab-content product-detail-content">
                                	<div id="type-<?= $product->id_product; ?>-1" class="tab-pane fade in active">
                                    	<h4><?= $product->description; ?></h4>
                                    	<div><?= $product->type; ?></div>
                                	</div>
                                	<div id="packaging-<?= $product->id_product; ?>-1" class="tab-pane fade"><?= $product->storage; ?></div>
                            	</div>
                        	</div>
                    	</div>
                    	<?php endforeach; ?>
                	...
                	<?php if (count($arr_product_other) > 0): ?>
                	...
                	<div class="col-xs-12 col-sm-12" style="padding: 0 5%;">
                    	<div class="owl-carousel owl-theme other-slider">
                        	...
                        	<div class="item item-product-other" data-product-other-id="<?= $product_other->id_product; ?>" style="cursor-pointer">
		...
		<script type="text/javascript">
		    ...
		    function slide() {
		        ...
		        owl.owlCarousel({ items: 4, itemsMobile: false, pagination: false, paginationSpeed: 900, navigation: true, navigationText: ['<i class="fa fa-angle-left fa-2x"></i>', '<i class="fa fa-angle-right fa-2x"></i>'] });
		    }
		    ...
		    function changeCoconutSlider() {
		        $(".coconut-item").click(function () {
		            ...
		            $("html, body").animate({ scrollTop: $("#product-detail-content-area").offset().top - 100 }, 1000);
		        });
