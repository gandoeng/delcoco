	...
	<body>
		<section class="career1">
    		...
    		<div class="container-fluid">
        		<div class="row">
            		<div class="col-xs-12 col-sm-12 nopad faq-pict" style="background-image: url(<?=base_url();?>images/career-pict.jpg);"><div class="col-xs-12 col-sm-12 nopad career-fill"></div>
            	</div>
        	</div>
        	<div class="career-stay-1"><img src="<?= base_url(); ?>images/faq-stay-1.png" /></div>
        	<div class="career-stay-2"><img src="<?= base_url(); ?>images/faq-stay-2.png" /></div>
    	</div>
	</section>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12">
					<div class="col-xs-12 col-sm-12 career-intro">
						...
						<div class="col-xs-12 col-sm-12 nopad line7"><hr /></div>
					...
					<div class="col-xs-12 col-sm-12">
						<div class="col-xs-3 col-sm-3 career-pills-wrapper">
							<ul class="nav nav-pills nav-stacked career-pills">
								<?php foreach ($arr_career as $key => $career): ?><?php if ($key <= 0): ?>
								<li class="line3"><hr/></li>
								<?php endif; ?>
								<li class="<?php if ($key <= 0): ?>active<?php endif; ?>">
									<a data-toggle="pill" href="#career-<?= $career->id; ?>"><?= $career->name; ?> <div class="active-arrow"></div></a>
								</li>
								<li class="line3"><hr/></li>
								<?php endforeach; ?>
							</ul>
						...
						<div class="col-xs-9 col-sm-9 tab-content career-pills-content">
							<?php foreach ($arr_career as $key => $career): ?>
							<div id="career-<?= $career->id; ?>" class="col-xs-12 col-sm-12 tab-pane fade <?php if ($key <= 0): ?>in active<?php endif; ?>">
								<div class="col-xs-12 col-sm-12 career-job-sum">
									<h4>Job Summary</h4>
									<p><?= $career->summary; ?></p>
									<div class="col-xs-12 col-sm-12 nopad line1"><hr /></div>
								</div>
