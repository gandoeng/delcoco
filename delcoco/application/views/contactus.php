...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<section class="index1"><?php $this->load->view('menu');?>
		...
		<section class="contact2">
			<div class="container-fluid">
				...
				<div class="col-xs-12 col-sm-12 text-center">
					<p><?php echo $this->lang->line('contact_info') ?> <a href="mailto:info@sarisegarhusada.com" target="_top">info@sarisegarhusada.com</a></p>
				</div>
					...
					<div class="col-xs-12 col-sm-12 nopad">
						<div class="col-xs-12 col-sm-6 left-side group-pad">
							<div class="form-group">
								...
								<input type="text" class="form-control input-lg trp patobo" id="name" placeholder="<?php echo $this->lang->line('contact_nameP') ?>">
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 right-side group-pad">
							<div class="form-group">
								<label for="phn"><?php echo $this->lang->line('contact_phone') ?></label>
								<input type="text" class="form-control input-lg trp patobo" id="phn" placeholder="<?php echo $this->lang->line('contact_phoneP') ?>">
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 left-side group-pad">
							<div class="form-group"><label for="email"><?php echo $this->lang->line('contact_email') ?></label>
								<input type="text" class="form-control input-lg trp patobo" id="email" placeholder="<?php echo $this->lang->line('contact_nameP') ?>">
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 right-side group-pad">
							<div class="form-group"><label for="confirm"><?php echo $this->lang->line('contact_email_conf') ?></label>
								<input type="text" class="form-control input-lg trp patobo" id="confirm" placeholder="<?php echo $this->lang->line('contact_email_confP') ?>">
							</div>
						</div>
						<div class="col-xs-12 col-sm-12 nopad group-pad">
							<div class="form-group">
								<label for="comment"><?php echo $this->lang->line('contact_message') ?></label>
								<textarea class="form-control input-lg trp" rows="5" id="comment" placeholder="<?php echo $this->lang->line('contact_messageP') ?>"></textarea>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 left-side group-pad">
							<div class="form-group">
								<label for="captcha">Captcha <div><?= $captcha['image'] ?></div></label>
								<input type="text" class="form-control input-lg trp patobo" id="captcha" placeholder="Type the number">
							</div>
						</div>
						<div class="col-xs-12 col-sm-12 nopad">
							<button id="submit" class="submit-btn" onclick="submitEnquiry();"><?php echo $this->lang->line('contact_send') ?></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDLdVpfVutE61qBptpPb25R_pIbIfNzGjI&sensor=false"></script>
		<script>
			...
			var marker, i;
			var icon = {url: "<?= base_url(); ?>images/pin.png", /* url */scaledSize: new google.maps.Size(100, 100),
				/* scaled size */
