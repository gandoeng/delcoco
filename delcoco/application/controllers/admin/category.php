...
class Category extends CI_Controller
{
	...
	public function add()
	{
		...
		$this->load->view('admin/category_add', $arr_data);
	}
	...
	public function edit($category_id)
	{
		...
		$this->load->view('admin/html', $arr_data);
		$this->load->view('admin/category_edit', $arr_data);
	}
	...
	public function view()
	{
		...
		$config = array();
        $config['base_url'] = base_url() . 'admin/category/view/';
		$config['total_rows'] = $this->core_model->count('category');
		...
		$this->load->view('admin/html', $arr_data);
		$this->load->view('admin/category', $arr_data);
	}
	...
	public function ajax_delete($category_id)
	{
		$json['status'] = 'success';
