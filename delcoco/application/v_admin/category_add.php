	...
	<script type="text/javascript">
		...
		function submit() {
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?= base_url() ?>admin/category/ajax_add/'
			});
		}
	</script>
	...
	<div id="category">
		...
		<div class="col-lg-8">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#category-details">Add Category</a></li>
			</ul>
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-lg-8 text-left">
								<input id="category-name" class="input-all" type="text" placeholder="Name.." value="">
							</div>
						</div>
