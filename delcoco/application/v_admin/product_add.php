	...
	<script type="text/javascript">
		...
		function submit() {
			...
			if (name == '' || description == '' || type == '' || storage == '' || imageId <= 0) {
				submitQuery = false;
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?= base_url() ?>admin/product/ajax_add/'
			});
		}
	</script>
				...
				<div id="product-details" class="tab-pane fade in active">
					...
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-lg-8 text-left">
								<textarea id="product-type" class="input-all" type="text" placeholder="Type.."></textarea>
							</div>
						</div>
						<hr class="separator"></hr>
						<div class="row">
							...
							<div class="col-lg-8 text-left">
								<textarea id="product-storage" class="input-all" type="text" placeholder="Storage.."></textarea>
							</div>
						</div>
						<hr class="separator"></hr>
						<div class="row">
