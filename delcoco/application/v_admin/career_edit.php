	...
	<script type="text/javascript">
		...
		function reset() {
			...
			$('#career-summary').val('<?= $career->summary; ?>');
		}
		...
		function submit() {
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?= base_url() ?>admin/career/ajax_edit/<?= $career->id; ?>/'
			});
		}
	</script>
	...
	<div id="career">
		...
		<div class="col-lg-8">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#career-details">Edit Career</a></li>
			</ul>
				...
				<div id="career-details" class="tab-pane fade in active">
					...
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-lg-8 text-left">
								<textarea id="career-qualification" class="input-all" type="text" placeholder="Qualification.."><?= $career->qualification; ?></textarea>
							</div>
						</div>
						<hr class="separator"></hr>
						<div class="row">
							...
							<div class="col-lg-8 text-left">
								<textarea id="career-description" class="input-all" type="text" placeholder="Description.."><?= $career->description; ?></textarea>
							</div>
						</div>
						<hr class="separator"></hr>
						<div class="row">
							...
							<div class="col-lg-8 text-left">
								<textarea id="career-education" class="input-all" type="text" placeholder="Education.."><?= $career->education; ?></textarea>
							</div>
						</div>
						<hr class="separator"></hr>
						<div class="row">
