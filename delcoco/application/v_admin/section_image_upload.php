`	<style type="text/css">
	...
	<script type="text/javascript">
		...
		function back() {
			window.location.href = '<?= base_url(); ?>admin/section/view/';
		}
		...
		function upload() {
			var file_data = $('#section-image').prop('files')[0];
			...
			$.ajax({
				...
				url: '<?= base_url(); ?>admin/image/ajax_upload_section/<?= $section->id; ?>/',
			});
		}
	</script>

	<div id="image-list">
		<h2>IMAGE - <?= $section->title; ?></h2>
		<p>All image for your section</p>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-12 no-padding text-left">
					<input id="section-image" class="input-all" type="file" placeholder="Upload Image.." value="">
