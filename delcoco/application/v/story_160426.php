...
<body>
					...
					<div class="wrapper-box">
						<div class="center-box center-block">
							<div class="wrapper-text-story-1 text-right">
								...
								<h5>SARI SEGAR HUSADA PRODUCT STORY</h5>
								<h7>KAMI MEMETIK KELAPA TERBAIK DARI TEMPAT TERBAIK</h7>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit 
								amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
							</div>
						</div>
					</div>
				</div>
	...
	<section class="story2">
		<div class="container-fluid">
					...
					<div class="wrapper-box-story-2">
						<div class="center-box center-block">
							<div class="wrapper-text-story-2 text-left">
								...
								<h7>MEMILIH KELAPA TERBAIK YANG TELAH DIPETIK</h7>
			...
			<div class="coco-story-4" data-start="transform:translate3d(0px, 0px, 0px);" data-end="transform:translate3d(0px, -800%, 0px);">
			...
			<div class="coco-mobile-story-2">
				<img src="<?= base_url(); ?>images/coco-mobile-story-2.png" />
			</div>
		</div>
	</section>
					...
					<div class="wrapper-box-story-3">
						<div class="center-box center-block">
							<div class="wrapper-text-story-3 text-right">
								...
								<h7>MENGIRIM KELAPA YANG SUDAH DIPILIH KE PABRIK</h7>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit 
						...
						<div class="wrapper-box-story-2">
							<div class="center-box center-block">
								<div class="wrapper-text-story-2 text-left">
									...
									<h7>MEMILIH DAN MENGUPAS KELAPA</h7>
									<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit.</p>
								</div>
							</div>
						</div>
					...
					<div class="wrapper-box-story-4">
						<div class="center-box center-block">
							<div class="wrapper-text-story-4 text-right">
								...
								<h7>KELAPA YANG TELAH DIKUPAS LALU DICUCI DAN DIOLAH</h7>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit 
								amet mauris. Morbi accumsan ipsum velit.</p>
							</div>
						</div>
				...
				<div class="col-xs-12 col-sm-12">
					<div class="col-xs-12 col-sm-4 text-center top-dis bot-mob">
						<div class="col-xs-12 col-sm-12 stay-story-2">
							<img src="<?= base_url(); ?>images/stay-story-2.png" />
						</div>
					...
					<div class="col-xs-12 col-sm-4 text-center bot-mob">
						<div class="col-xs-12 col-sm-12 stay-story-3">
							<img src="<?= base_url(); ?>images/stay-story-3.png" />
						</div>
						<div class="col-xs-12 col-sm-12 guard">
							<h2>NATA DE COCO</h2>
							<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum aucto.</p>
					...
					<div class="col-xs-12 col-sm-4 text-center top-dis bot-mob">
						<div class="col-xs-12 col-sm-12 stay-story-4">
							<img src="<?= base_url(); ?>images/stay-story-4.png" />
						</div>
						<div class="col-xs-12 col-sm-12 guard">
							<h2>DESSICATED COCONUT</h2>
							<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum aucto.</p>
						</div>
					</div>
				</div>
	...
	<section class="story6">
		<div class="container-fluid">
				...
				<div class="wrapper-box-story-2">
					<div class="center-box center-block">
						<div class="wrapper-text-story-2 text-left">
							...
							<h7>LOREM IPSUM DOLOR SIT AMET VEL VELIT AUCTHOR</h7>
							<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit.</p>
						</div>
					</div>
				</div>
			...
			<div class="stay-story-5" id="slide1">
				<img src="<?= base_url(); ?>images/slide-story-1.png" />
			</div>
			<div class="stay-story-6" id="slide2">
				<img src="<?= base_url(); ?>images/slide-story-2.png" />
			</div>
		</div>
	</section>
