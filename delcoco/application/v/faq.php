...
<body>
	<section class="faq1">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12 col-sm-12 nopad faq-pict" style="background-image:url(<?= base_url();?>images/image-about-2.jpg);">
					<div class="col-xs-12 col-sm-12 nopad faq-fill">
					</div>
				</div>
			</div>
			<div class="faq-stay-1">
				<img src="<?= base_url(); ?>images/faq-stay-1.png" />
			</div>
			<div class="faq-stay-2">
									...
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse1">
										<div class="panel-heading row faq-panel-head" onclick="putar('#pict1');">
											<div class="col-xs-9 col-sm-9 v-center subtitle">
												<h4><?= $count; ?>. <?= $faq->question; ?></h4>
											</div><!--
											--><div class="col-xs-3 col-sm-3 text-right v-center faq-panel-pict">
												<img src="images/faq-toggle.png" class="rot" id="pict1" />
											</div>
										</div>
									</a>
									<div id="collapse1" class="panel-collapse collapse">
										<div class="panel-body faq-panel-content">
											<div class="col-xs-12 col-sm-12 faq-panel-par">
												<?= $faq->answer; ?>
											</div>
										</div>
									</div>
									<div class="col-xs-12 col-sm-12 nopad line6">
										<hr />
									</div>
								</div>
							<? endforeach; ?>
