			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12">
					<div class="col-xs-12 col-sm-6 recipe-detail-big-pict" style="background-image:url(<?= base_url(); ?>images/website/<?= $recipe->image_name; ?>);">
						<div class="col-xs-12 col-sm-12 nopad" style="background-image:url(<?= base_url();?>images/pattern3.png);">
							<div class="recipe-detail-pict-padding">
							</div>
						</div>
					</div>
				...
				<div class="col-xs-12 col-sm-12 detail-recipe-msg">
					...
					<div class="col-xs-12 col-sm-6 left-side group-pad">
						<div class="form-group">
							...
							<input type="text" class="form-control input-lg trp patobo" id="name" placeholder="Your Name">
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-12 nopad">
						<button id="submit" class="submit-btn" onclick="submitEnquiry();">Send Message</button>
					</div>
				</div>
			</div>
			<div class="recipe-detail-stay-1">
				<img src="<?= base_url(); ?>images/recipe-detail-stay-1.png" />
			</div>
			<div class="recipe-detail-stay-2">
	...
	<section class="recipe-detail-3">
		<div class="container-fluid recipe-detail-section-3">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12">
					<? foreach ($arr_related_recipe as $key => $related_recipe): ?>
						<div class="col-xs-12 col-sm-4 recipe-list">
							<div class="col-xs-12 col-sm-12 recipe-image-wrap">
								<div class="col-xs-12 col-sm-12 recipe-image" style="background-image:url(<?= base_url(); ?>images/website/<?= $related_recipe->image_name; ?>);">
								</div>
							</div>
