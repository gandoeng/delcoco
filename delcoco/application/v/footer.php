			...
			<div class="col-xs-12 col-sm-12 text-center">
				...
				<div class="col-xs-6 col-sm-4 text-left">
					<div class="col-xs-12 col-sm-12 nopad">
						...
						<div class="col-xs-12 col-sm-12 nopad">
							<h6>Phone : <?= $setting->company_phone; ?></h6>
							<h6>Email : <?= $setting->company_email; ?></h6>
						</div>
					</div>
					<div class="col-xs-12 col-sm-12 nopad news">
						...
						<div class="col-xs-12 col-sm-12 nopad news-fill">
							<div class="col-xs-12 col-sm-5 nopad">
								<input type="text" id="newsletter-email" class="form-control email" name="email" placeholder="Email"><br>
							</div>
							<div class="col-xs-12 col-sm-3 submit-box">
								<button id="submit" class="btn submit" onclick="submitNewsletter();";>SUBMIT</button>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-sm-2 text-left footer-margin">
					<div class="col-xs-12 col-sm-12 nopad">
						...
						<div class="col-xs-12 col-sm-12 nopad">
							<h6><a href="<?= base_url();?>aboutus">About Us</a></h6>
							<h6><a href="<?= base_url();?>recipe">Recipes</a></h6>
							<h6><a href="<?= base_url();?>product">Products</a></h6>
							<h6><a href="<?= base_url();?>faq">FAQ</a></h6>
							<h6><a href="<?= base_url();?>career">Careers</a></h6>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-sm-2 text-left footer-margin">
					<div class="col-xs-12 col-sm-12 nopad">
						...
						<div class="col-xs-12 col-sm-12 nopad">
								...
								<? if ($setting->setting__social_media_facebook_link != ''): ?>
									<a href="<?= $setting->setting__social_media_facebook_link; ?>" target="_blank">
										<div class="fb-box text-center">
											<i class="fa fa-facebook v-center fb-icon"></i>
										</div>
										<div class="fb-text">
											<h6>Facebook</h6>
										</div>
							...
							<div class="col-xs-12 col-sm-12 nopad twit">
								<? if ($setting->setting__social_media_twitter_link != ''): ?>
									<a href="<?= $setting->setting__social_media_twitter_link; ?>" target="_blank">
										<div class="twit-box text-center">
											<i class="fa fa-twitter v-center twit-icon"></i>
										</div>
										<div class="twit-text">
											<h6>Twitter</h6>
										</div>
							...
							<div class="col-xs-12 col-sm-12 nopad yt">
								<? if ($setting->setting__social_media_youtube_link != ''): ?>
									<a href="<?= $setting->setting__social_media_youtube_link; ?>" target="_blank">
										<div class="yt-box text-center">
											<i class="fa fa-youtube-play v-center yt-icon"></i>
										</div>
										<div class="yt-text">
											<h6>Youtube</h6>
										</div>
							...
							<div class="col-xs-12 col-sm-12 nopad ig">
								<? if ($setting->setting__social_media_instagram_link != ''): ?>
									<a href="<?= $setting->setting__social_media_instagram_link; ?>" target="_blank">
										<div class="ig-box text-center">
											<i class="fa fa-instagram v-center ig-icon"></i>
										</div>
										<div class="ig-text">
											<h6>Instagram</h6>
										</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12">
				<div class="col-xs-6 col-sm-6 text-left">
					<h6><?= $setting->system_copyright; ?> <?= $setting->system_company_name; ?></h6>
				</div>
				<div class="col-xs-6 col-sm-6 text-right footer-label">
					<h6>Imagined by <?= $setting->system_vendor_name; ?></h6>
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	function submitNewsletter() {
		...
		$.ajax({
			...
			type : 'POST',
			url : '<?= base_url() ?>main/ajax_add_subscribe/'
		});
	}
</script>