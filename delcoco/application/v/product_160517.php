			...
			<div class="row">
				<div class="col-xs-12 col-sm-12">
					<div class="col-xs-12 col-sm-4 v-center product1-title-wrap">
						<h1>SARI SEGAR HUSADA PRODUCT</h1>
					...
					--><div class="col-xs-12 col-sm-4 v-center product1-content">
						<div class="col-xs-12 col-sm-12">
							<h4>Coconut Milk Benefits:</h4>
						</div>
					...
					<div class="col-xs-12 col-sm-4 col-sm-offset-4">
						<div class="owl-carousel owl-theme product-slider-1">
							<div class="item item-benefit">
								<div class="green-circle benefit-opacity-off">
									<div class="white-circle-border">
										<div class="circle-padding">
										</div>
									</div>
								</div>
								<div class="item-pict text-center" id="benefit-1">
									<img src="<?= base_url(); ?>images/product-slide-1.png" data-src="<?= base_url(); ?>images/product-slide-1.png" />
								</div>
							</div>
							<div class="item item-benefit benefit-active">
								<div class="green-circle benefit-opacity-on">
									<div class="white-circle-border">
										<div class="circle-padding">
										</div>
									</div>
								</div>
								<div class="item-pict text-center">
									<img src="<?= base_url(); ?>images/product-slide-2.png" data-src="<?= base_url(); ?>images/susu.png" />
								</div>
							</div>
							<div class="item item-benefit">
								<div class="green-circle benefit-opacity-off">
								...
								<div class="item-pict text-center">
									<img src="<?= base_url(); ?>images/product-slide-3.png" data-src="<?= base_url(); ?>images/air-kelapa.png" />
								</div>
							</div>
							<div class="item item-benefit">
								<div class="green-circle benefit-opacity-off">
								...
								<div class="item-pict text-center">
									<img src="<?= base_url(); ?>images/product-slide-4.png" data-src="<?= base_url(); ?>images/product-slide-4.png" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="wrapper-box-product-1">
						<div class="center-box text-center center-block">
							<div class="wrapper-text-product-1 text-center">
								<h3>“This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor.”</h3>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12">
					...
					<div class="col-xs-12 col-sm-12" style="padding:0 5%;">
						<div class="owl-carousel owl-theme coconut-slider">
							<div class="item coconut-item" data-product-id="1">
								<div class="bottom-border">
									<div class="triangle triangle-opacity-on"></div>
									<div class="green-circle-border">
										<div class="coconut-slider-pict" style="background-image:url(<?= base_url(); ?>images/product-coconut-1.png);">
											<div class="white-overlay overlay-opacity-off">
												<div class="coconut-slider-text">
													<h5>Coconut Something</h5>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="item coconut-item" data-product-id="2">
								<div class="bottom-border">
									<div class="triangle triangle-opacity-off"></div>
									<div class="green-circle-border">
										<div class="coconut-slider-pict" style="background-image:url(<?= base_url(); ?>images/product-coconut-2.png);">
											<div class="white-overlay overlay-opacity-on">
												<div class="coconut-slider-text">
													<h5>Coconut Cream / Milk</h5>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="item coconut-item" data-product-id="3">
								<div class="bottom-border">
									<div class="triangle triangle-opacity-off"></div>
									<div class="green-circle-border">
										<div class="coconut-slider-pict" style="background-image:url(<?= base_url(); ?>images/product-coconut-3.png);">
											<div class="white-overlay overlay-opacity-on">
												<div class="coconut-slider-text">
													<h5>Coconut Water</h5>
												</div>
							...
							<div class="item coconut-item" data-product-id="4">
								<div class="bottom-border">
									<div class="triangle triangle-opacity-off"></div>
									<div class="green-circle-border">
										<div class="coconut-slider-pict" style="background-image:url(<?= base_url(); ?>images/product-coconut-4.png);">
											<div class="white-overlay overlay-opacity-on">
												<div class="coconut-slider-text">
													<h5>Coconut Gel / Nata De Coco</h5>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="item coconut-item" data-product-id="5">
								<div class="bottom-border">
									<div class="triangle triangle-opacity-off"></div>
									<div class="green-circle-border">
										<div class="coconut-slider-pict" style="background-image:url(<?= base_url(); ?>images/product-coconut-5.png);">
											<div class="white-overlay overlay-opacity-on">
												<div class="coconut-slider-text">
													<h5>Coconut Oil</h5>
												</div>
							...
							<div class="item coconut-item" data-product-id="6">
								<div class="bottom-border">
									<div class="triangle triangle-opacity-off"></div>
									<div class="green-circle-border">
										<div class="coconut-slider-pict" style="background-image:url(<?= base_url(); ?>images/product-coconut-1.png);">
					...
					<div class="col-xs-12 col-sm-12 product-detail">
						<div id="product-detail-1" class="content-product">
							<div class="col-xs-12 col-sm-5">
								<div class="col-xs-12 col-sm-12 nopadleft product-big-zoom-wrap">
									<div class="col-xs-12 col-sm-12 nopad product-big-zoom" style="background-image:url(<?= base_url(); ?>images/product-zoom-1.png);">
										
									</div>
								</div>
								<div class="col-xs-12 col-sm-12 nopad product-small-zoom-wrap">
									<div class="col-xs-4 col-sm-4 nopadleft product-small-zoom">
										<div class="col-xs-12 col-sm-12 product-small-border" style="background-image:url(<?= base_url(); ?>images/product-zoom-1.png);" data-src="<?= base_url(); ?>images/product-zoom-1.png">
										</div>
									</div>
									<div class="col-xs-4 col-sm-4 nopadleft product-small-zoom">
										<div class="col-xs-12 col-sm-12 product-small-border" style="background-image:url(<?= base_url(); ?>images/product-zoom-2.png);" data-src="<?= base_url(); ?>images/product-zoom-2.png">
										</div>
									</div>
									<div class="col-xs-4 col-sm-4 nopadleft product-small-zoom">
										<div class="col-xs-12 col-sm-12 product-small-border" style="background-image:url(<?= base_url(); ?>images/product-zoom-3.png);" data-src="<?= base_url(); ?>images/product-zoom-3.png">
										</div>
									</div>
								</div>
							</div>
							<div class="col-xs-12 col-sm-7 product-detail-tab-wrapper">
								<ul class="nav nav-pills product-detail-tab">
									<li class="active"><a data-toggle="pill" href="#type-1">Product Type</a></li>
									<li><a data-toggle="pill" href="#packaging-1">Packaging & Storage</a></li>
								</ul>

								<div class="tab-content product-detail-content">
									<div id="type-1" class="tab-pane fade in active">
										<h4>PRODUCT 1</h4>
										...
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
										...
										Sed ut imperdiet nisi.</p>
									</div>
									<div id="packaging-1" class="tab-pane fade">
										<h4>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
										condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi.</p>
						...
						<div id="product-detail-2" class="content-product display-none">
							<div class="col-xs-12 col-sm-5">
								<div class="col-xs-12 col-sm-12 nopadleft product-big-zoom-wrap">
									<div class="col-xs-12 col-sm-12 nopad product-big-zoom" style="background-image:url(<?= base_url(); ?>images/product-zoom-1.png);">
							...
							<div class="col-xs-12 col-sm-7 product-detail-tab-wrapper">
								<ul class="nav nav-pills product-detail-tab">
									<li class="active"><a data-toggle="pill" href="#type-2">Product Type</a></li>
									<li><a data-toggle="pill" href="#packaging-2">Packaging & Storage</a></li>
								</ul>
								...
								<div class="tab-content product-detail-content">
									...
									<div id="packaging-2" class="tab-pane fade">
										<h4>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
						...
						<div id="product-detail-3" class="content-product display-none">
							<div class="col-xs-12 col-sm-5">
								<div class="col-xs-12 col-sm-12 nopadleft product-big-zoom-wrap">
									<div class="col-xs-12 col-sm-12 nopad product-big-zoom" style="background-image:url(<?= base_url(); ?>images/product-zoom-1.png);">
							...
							<div class="col-xs-12 col-sm-7 product-detail-tab-wrapper">
								<ul class="nav nav-pills product-detail-tab">
									<li class="active"><a data-toggle="pill" href="#type-3">Product Type</a></li>
									<li><a data-toggle="pill" href="#packaging-3">Packaging & Storage</a></li>
								</ul>

								<div class="tab-content product-detail-content">
									<div id="type-3" class="tab-pane fade in active">
										<h4>PRODUCT 3</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
									...
									<div id="packaging-3" class="tab-pane fade">
										<h4>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
						...
						<div id="product-detail-4" class="content-product display-none">
							<div class="col-xs-12 col-sm-5">
								<div class="col-xs-12 col-sm-12 nopadleft product-big-zoom-wrap">
									<div class="col-xs-12 col-sm-12 nopad product-big-zoom" style="background-image:url(<?= base_url(); ?>images/product-zoom-1.png);">
							...
							<div class="col-xs-12 col-sm-7 product-detail-tab-wrapper">
								<ul class="nav nav-pills product-detail-tab">
									<li class="active"><a data-toggle="pill" href="#type-4">Product Type</a></li>
									<li><a data-toggle="pill" href="#packaging-4">Packaging & Storage</a></li>
								</ul>

								<div class="tab-content product-detail-content">
									<div id="type-4" class="tab-pane fade in active">
										<h4>PRODUCT 4</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
									...
									<div id="packaging-4" class="tab-pane fade">
										<h4>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
						...
						<div id="product-detail-5"  class="content-product display-none">
							<div class="col-xs-12 col-sm-5">
								<div class="col-xs-12 col-sm-12 nopadleft product-big-zoom-wrap">
									<div class="col-xs-12 col-sm-12 nopad product-big-zoom" style="background-image:url(<?= base_url(); ?>images/product-zoom-1.png);">
							...
							<div class="col-xs-12 col-sm-7 product-detail-tab-wrapper">
								<ul class="nav nav-pills product-detail-tab">
									<li class="active"><a data-toggle="pill" href="#type-5">Product Type</a></li>
									<li><a data-toggle="pill" href="#packaging-5">Packaging & Storage</a></li>
								</ul>

								<div class="tab-content product-detail-content">
									<div id="type-5" class="tab-pane fade in active">
										<h4>PRODUCT 5</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
									...
									<div id="packaging-5" class="tab-pane fade">
										<h4>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
						...
						<div id="product-detail-6" class="content-product display-none">
							<div class="col-xs-12 col-sm-5">
								<div class="col-xs-12 col-sm-12 nopadleft product-big-zoom-wrap">
									<div class="col-xs-12 col-sm-12 nopad product-big-zoom" style="background-image:url(<?= base_url(); ?>images/product-zoom-1.png);">
							...
							<div class="col-xs-12 col-sm-7 product-detail-tab-wrapper">
								<ul class="nav nav-pills product-detail-tab">
									<li class="active"><a data-toggle="pill" href="#type-6">Product Type</a></li>
									<li><a data-toggle="pill" href="#packaging-6">Packaging & Storage</a></li>
								</ul>

								<div class="tab-content product-detail-content">
									<div id="type-6" class="tab-pane fade in active">
										<h4>PRODUCT 6</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
									...
									<div id="packaging-6" class="tab-pane fade">
										<h4>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.</h4>
										<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
										Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
										<p>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus 
					...
					<div class="col-xs-12 col-sm-12 product-other-title">
						<img src="<?= base_url(); ?>images/stay5.png" />
						...
						<div class="owl-carousel owl-theme other-slider">
							<div class="item">
								<div class="other-image">
									<img src="<?= base_url(); ?>images/product-other-1.png" />
								</div>
								<div class="other-net">
									<p>Desiccated Coconut</p>
								</div>
								<div class="other-size">
									<h6>Size: 45cm x 75cm</h6>
								</div>
							</div>
							<div class="item">
								<div class="other-image">
									<img src="<?= base_url(); ?>images/product-other-2.png" />
								</div>
								<div class="other-net">
									<p>Nata De Coco</p>
								</div>
							...
							<div class="item">
								<div class="other-image">
									<img src="<?= base_url(); ?>images/product-other-3.png" />
								</div>
								<div class="other-net">
									<p>Coconut Oil</p>
								</div>
							...
							<div class="item">
								<div class="other-image">
									<img src="<?= base_url(); ?>images/product-other-4.png" />
								</div>
								<div class="other-net">
									<p>Coconut Milk</p>
								</div>
							...
							<div class="item">
								<div class="other-image">
									<img src="<?= base_url(); ?>images/product-other-5.png" />
								</div>
								<div class="other-net">
									<p>Coconut Water</p>
								</div>
