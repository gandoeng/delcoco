...
<body>
	...
	<section class="story5">
		<div class="container-fluid sec-story5">
			...
			<div class="coco-story-11" data-start="transform:translate3d(0px, 0px, 0px);" data-end="transform:translate3d(0px, 600%, 0px);">
			...
			<div class="coco-story-13" data-start="transform:translate3d(0px, 0px, 0px);" data-end="transform:translate3d(0px, 900%, 0px);">
